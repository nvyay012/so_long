...
void	fill_items(t_vars *data)
{
	...
	data->carp = mlx_xpm_file_to_image(data->mlx_ptr, "./textures/carp.xpm",
	...
	data->floor = mlx_xpm_file_to_image(data->mlx_ptr, "./textures/wall.xpm",
			&data->image_width, &data->image_height);
	data->potion = mlx_xpm_file_to_image(data->mlx_ptr, "./textures/potion.xpm",
			&data->image_width, &data->image_height);
	fill_items2(data);
	check_file(data);
}
...
void	fill_items2(t_vars *data)
{
	data->player_left = mlx_xpm_file_to_image(data->mlx_ptr,
			"./textures/carp_left.xpm", &data->image_width,
			&data->image_height);
	data->player_right = mlx_xpm_file_to_image(data->mlx_ptr,
			"./textures/carp_right.xpm", &data->image_width,
			&data->image_height);
	data->player_down = mlx_xpm_file_to_image(data->mlx_ptr,
			"./textures/carp_down.xpm", &data->image_width,
			&data->image_height);
}
...
void	map_draw(t_vars *data, int i, int j)
{
	if (data->map[i][j] == '1')
		...
		mlx_put_image_to_window(data->mlx_ptr, data->mlx_window, data->potion,
			j * 30, i * 30);
}
